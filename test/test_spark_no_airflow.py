...
from pyspark.sql.functions import (
    from_unixtime, col, explode, when,
    to_timestamp
)
...
def spark_json_to_parquet(aws_conn_id='aws_s3', **kwargs):
    ...
    s3_input_path = f"s3://{S3_BUCKET}/{RAW_VELIB_SS}/{s3_input_path}"
